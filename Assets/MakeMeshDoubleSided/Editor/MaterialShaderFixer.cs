    ...
    public static class MaterialShaderFixer
    {
        ...
        public static void FixMaterials()
        {
            ...
            if (currentRenderPipline != createdForRenderPipleline)
            {
                ...
                {
                     { Installer.AssetRootPath + "Examples/Materials/Arm.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("24738C") ) },
                     { Installer.AssetRootPath + "Examples/Materials/Bowl Inside.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("844C00") ) },
                     { Installer.AssetRootPath + "Examples/Materials/Bowl Outside.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("FFFFFF"), "132d37037274a384abc28bd3a82f2ab4" ) },
                     { Installer.AssetRootPath + "Examples/Materials/Bracer.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("823317") ) },
                     { Installer.AssetRootPath + "Examples/Materials/Cube.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("C0A048") ) },
                     { Installer.AssetRootPath + "Examples/Materials/Hand.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("D6B858") ) },
                };
